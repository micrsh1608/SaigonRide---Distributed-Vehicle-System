...
with codecs.open('C:/Users/micrsh/source/repos/SaigonBus/SaigonBus/Views/Home/UserDashboard.cshtml', 'r', encoding='utf-8-sig') as f:
    content = f.read()
...
if 'id="momo-link-container"' not in content:
    content = content.replace('<h5 class="fw-bold mb-3"><i class="fas fa-history text-muted me-2"></i>Lịch sử nạp tiền</h5>', wallet_html_replacement + '\n<h5 class="fw-bold mb-3"><i class="fas fa-history text-muted me-2"></i><span data-i18n="wallet_history">Lịch sử nạp tiền</span></h5>')
        ...
        function promptLinkAccount(method) {
            ...
            if (info) {
                fetch('/Account/LinkAccount', {
                    ...
                    body: 'method=' + method + '&accountInfo=' + encodeURIComponent(info)
...
with codecs.open('C:/Users/micrsh/source/repos/SaigonBus/SaigonBus/Views/Home/UserDashboard.cshtml', 'w', encoding='utf-8') as f:
    f.write(content)

print("UserDashboard.cshtml updated safely.")
